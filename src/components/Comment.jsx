                ...
                item?.parentId === null && (
                    <article key={item?._id} className="relative max-w-[960px] mx-auto py-6 text-base bg-white border-gray-200 border-l-2 pl-4 mb-6 dark:border-white-700 dark:bg-gray-800" >
                        <footer className="flex justify-between items-center mb-2">
                            ...
                            <div
                                ...
                                <ul className="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    {
                                        (user?.role === 'ADMIN' || user?._id === item.author) && (
                                            <>
                                                ...
                                                <li onClick={() => setIsEditCom({ isOpen: true, commentContent: item?.comment })}>
                        ...
                        <div ref={inp} className='inp hidden'>
                            <form className='mb-6 mt-6 max-w-[910px]'>
                                <div className="py-2 mr-4 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                                    <label htmlFor="comment" className="sr-only">Your comment</label>
                                    <textarea id="comment" rows="2"
                                        value={comment}
                                ...
                                <button
                                    ...
                                    type='button'
                                    onClick={() => handlingReply(item?._id, item?.username, item?.author)}
                                    className="bg-blue-500 inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800 disabled:opacity-75">
                                    Reply
                                </button>
                                <button
